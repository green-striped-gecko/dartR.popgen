  ...
  if (OS == "Windows") {
    ...
    if (!is.null(nhyb.directory)) {
      ...
      if (outpath == nhyb.directory) {
        stop(error(
          "Fatal Error: Directory for the NewHybrids executable cannot be the same as",
