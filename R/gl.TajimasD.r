...
#' Simulation results can only be output if ms and sample_stats are compiled
#' (can be installed at:
#' https://uchicago.app.box.com/s/l3e5uf13tikfjm7e1il1eujitlsjdx13)
#' @description
#' This function calculate Tajima's D, with p-values from beta distribution,
#' standard normal distribution and simulation from ms (Hudson, 2002)
#'
